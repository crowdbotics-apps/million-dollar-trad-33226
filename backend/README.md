...
## Project Structure
    ...
    ├── million_dollar_trad_33226  # Django project configurations
...
1. Clone this repo and `cd million_dollar_trad_33226`
...
2. Clone this repo and `cd million_dollar_trad_33226`
